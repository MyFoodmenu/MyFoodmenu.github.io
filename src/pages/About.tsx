      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            About <span className="text-gradient">MyFoodMenu</span>
          </h1>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-4">
                Founded in 2020, MyFoodMenu started with a simple idea: everyone deserves access to great food without the hassle. What began as a small team of food enthusiasts has grown into a platform serving thousands of happy customers daily.
              </p>
              <p className="text-muted-foreground mb-4">
        ...
        <section className="bg-muted/30 rounded-2xl p-8 md:p-12">
          ...
          <p className="text-center text-muted-foreground max-w-2xl mx-auto mb-6">
            We're always looking for passionate individuals to join our growing team. Whether you're a driver, customer support specialist, or tech enthusiast, there's a place for you at MyFoodMenu.
          </p>
          <p className="text-center">
            Contact us at <a href="mailto:careers@myfoodmenu.com" className="text-primary font-semibold hover:underline">careers@myfoodmenu.com</a>
          </p>
        </section>
      </div>
    </Layout>
